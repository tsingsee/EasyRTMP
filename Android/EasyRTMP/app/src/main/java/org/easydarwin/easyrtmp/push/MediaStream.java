...
import org.easydarwin.easyrtmp.hw.EncoderDebugger;
import org.easydarwin.easyrtmp.hw.NV21Convertor;
...
public class MediaStream {
    ...
    EasyRTMP mEasyRTMP;
    static final String TAG = "EasyRTMP.MediaStream";
    ...
    public MediaStream(Context context, SurfaceHolder holder) {
        ...
        audioStream = new AudioStream(mEasyRTMP);
    }
...
//    }
    ...
    private void initPusher(String url, EasyRTMP.OnInitPusherCallback callback) {
        try {
            mEasyRTMP.initPush(url, mApplicationContext, callback);
        } catch (Exception e) {
            Log.i("", "");
        }
    }
...
//                        Log.e("out_data", data0);
    ...
    public void startStream(String url, EasyRTMP.OnInitPusherCallback callback) {
        initPusher(url, callback);
        pushStream = true;
